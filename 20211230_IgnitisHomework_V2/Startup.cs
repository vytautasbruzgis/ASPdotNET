...
namespace _20211230_IgnitisHomework_V2
{
    public class Startup
    {
        ...
        public void ConfigureServices(IServiceCollection services)
        {
            ...
            services.AddTransient<RegistrationAttributeRepository>();
            services.AddTransient<AttributeRepository>();
            services.AddTransient<AttributeOptionRepository>();
            services.AddTransient<RegistrationService>();
            services.AddTransient<RegistrationAttributeService>();
            services.AddTransient<AttributeService>();
            services.AddTransient<AttributeOptionService>();
        } 
